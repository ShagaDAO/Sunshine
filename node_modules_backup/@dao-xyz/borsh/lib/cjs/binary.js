...
class BinaryWriter {
    ...
    static u8(value, writer) {
        (0, bigint_js_1.checkInt)(value, 0, 0xff, 1);
        let offset = writer.totalSize;
    ...
    static u16(value, writer) {
        let offset = writer.totalSize;
        writer._writes = writer._writes.next = () => (0, bigint_js_1.writeUInt16LE)(value, writer._buf, offset);
        writer.totalSize += 2;
    }
    u32(value) {
    ...
    static u32(value, writer) {
        let offset = writer.totalSize;
        writer._writes = writer._writes.next = () => (0, bigint_js_1.writeUInt32LE)(value, writer._buf, offset);
        writer.totalSize += 4;
    }
    u64(value) {
    ...
    static u64(value, writer) {
        let offset = writer.totalSize;
        writer._writes = writer._writes.next = () => (0, bigint_js_1.writeBigUint64Le)(value, writer._buf, offset);
        writer.totalSize += 8;
    }
    u128(value) {
    ...
    static u128(value, writer) {
        let offset = writer.totalSize;
        writer._writes = writer._writes.next = () => (0, bigint_js_1.writeBufferLEBigInt)(value, 16, writer._buf, offset);
        writer.totalSize += 16;
    }
    u256(value) {
    ...
    static u256(value, writer) {
        let offset = writer.totalSize;
        writer._writes = writer._writes.next = () => (0, bigint_js_1.writeBufferLEBigInt)(value, 32, writer._buf, offset);
        writer.totalSize += 32;
    }
    u512(value) {
    ...
    static u512(value, writer) {
        let offset = writer.totalSize;
        writer._writes = writer._writes.next = () => (0, bigint_js_1.writeBufferLEBigInt)(value, 64, writer._buf, offset);
        writer.totalSize += 64;
    }
    f32(value) {
    ...
    static f32(value, writer) {
        ...
        let offset = writer.totalSize;
        writer._writes = writer._writes.next = () => (0, float_1.writeFloatLE)(value, writer._buf, offset);
        writer.totalSize += 4;
    }
    f64(value) {
    ...
    static f64(value, writer) {
        ...
        let offset = writer.totalSize;
        writer._writes = writer._writes.next = () => (0, float_1.writeDoubleLE)(value, writer._buf, offset);
        writer.totalSize += 8;
    }
    string(str) {
    ...
    static stringCustom(str, writer, lengthWriter = bigint_js_1.writeUInt32LE, lengthSize = 4) {
    ...
    static uint8Array(array, writer) {
        let offset = writer.totalSize;
        writer._writes = writer._writes.next = () => {
            (0, bigint_js_1.writeUInt32LE)(array.length, writer._buf, offset);
            writer._buf.set(array, offset + 4);
        };
        writer.totalSize += array.length + 4;
    }
    static uint8ArrayCustom(array, writer, lengthWriter = bigint_js_1.writeUInt32LE, lengthSize = 4) {
        let offset = writer.totalSize;
        writer._writes = writer._writes.next = () => {
    ...
    static smallNumberEncoding(encoding) {
        if (encoding === 'u8') {
            ...
            return [bigint_js_1.writeUInt16LE, 2];
        }
        else if (encoding === 'u32') {
            return [bigint_js_1.writeUInt32LE, 4];
        }
        else {
...
class BinaryReader {
    ...
    static bool(reader) {
        ...
        reader._offset += 1;
        if (value !== 1 && value !== 0) {
            throw new error_js_1.BorshError("Unexpected value for boolean: " + value + ". Expecting either 1 or 0 ");
        }
    ...
    static u8(reader) {
        if (reader._offset >= reader._buf.length) {
            throw new error_js_1.BorshError("Reader out of bounds");
        }
        const value = reader._buf[reader._offset];
        reader._offset += 1;
        return value;
    ...
    static u16(reader) {
        const value = (0, bigint_js_1.readUInt16LE)(reader._buf, reader._offset);
        reader._offset += 2;
        return value;
    }
    u32() {
    ...
    static u32(reader) {
        const value = (0, bigint_js_1.readUInt32LE)(reader._buf, reader._offset);
        reader._offset += 4;
        return value;
    }
    u64() {
    ...
    static u64(reader) {
        const value = (0, bigint_js_1.readBigUInt64LE)(reader._buf, reader._offset);
        reader._offset += 8;
        return value;
    }
    u128() {
    ...
    static u128(reader) {
        const value = (0, bigint_js_1.readUIntLE)(reader._buf, reader._offset, 16);
        reader._offset += 16;
        return value;
    }
    u256() {
    ...
    static u256(reader) {
        const value = (0, bigint_js_1.readUIntLE)(reader._buf, reader._offset, 32);
        reader._offset += 32;
        return value;
    }
    u512() {
    ...
    static u512(reader) {
        ...
        return (0, bigint_js_1.toBigIntLE)(buf);
    }
    f32() {
